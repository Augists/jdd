...
public class TestZDD2 {
	...
	@Test public void testBasics() {
		...
		assertEquals("TOS restored after mul", zdd.debug_work_stack_size(), 0);
		...
		assertEquals("P / Q", tmp3, answer);
		assertEquals("TOS restored after div (1)", zdd.debug_work_stack_size(), 0);
		...
		assertEquals("TOS restored after div (2)", zdd.debug_work_stack_size(), 0);
	}
    ...
    @Test public void testScalar() {	    
        ...
        assertEquals("TOS restored after div (3)", zdd.debug_work_stack_size(), 0);        
        ...
        assertEquals("TOS restored after mod", zdd.debug_work_stack_size(), 0);
        ...
        assertEquals("TOS restored after div (4)", zdd.debug_work_stack_size(), 0);
        ...
        assertEquals("TOS restored after mod (2)", zdd.debug_work_stack_size(), 0);
        ...
        assertEquals("TOS restored after mul (2)", zdd.debug_work_stack_size(), 0);
